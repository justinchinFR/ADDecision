 ...
 * @since AM 5.5.0
 */
public class ADDecisionPlugin extends AbstractNodeAmPlugin {

	static private String currentVersion = "4.2";
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(ADDecisionPlugin.currentVersion, 
				Collections.singletonList(ADDecision.class));
	}
	...
	public void upgrade(String fromVersion) throws PluginException {
		pluginTools.upgradeAuthNode(ADDecision.class);
	...
	public String getPluginVersion() {
		return ADDecisionPlugin.currentVersion;
	}
}
